...
const Banner = () => {
  return (
    <div className='relative w-full'>
            ...
            <div className='inset-0 absolute bg-black opacity-30 h-full'></div>
        ...
        <div className='max-w-2xl absolute p-5 text-white top-0 text-center w-full mx-auto left-0 right-0 flex flex-col justify-center items-center h-full'>
            <h1 className='text-5xl md:text-7xl font-bold capilize'>Make your 1stMove to bring success!</h1>
