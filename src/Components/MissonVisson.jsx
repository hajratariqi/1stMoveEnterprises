  ...
  return (
    <div id={id} className='container p-6 mx-auto my-20 flex gap-5 flex-col md:flex-row justify-between items-center'>
      <div className='md:w-2/4'>
        ...
        <p className='my-4 text-gray-600 text-center md:text-start font-semibold font-poppins !leading-normal'>Keep your dreams alive. Understand to achieve anything requires faith and belief in yourself, vision, hard work, determination, and dedication. Remember all things are possible for those who believe</p>
        <h3 className='text-2xl font-bold mb-3 text-center md:text-start'>Our Vision</h3>
        <p className='text-gray-600 text-sm !leading-normal text-center md:text-start'>At 1st Move Enterprises, our vision is to
        ...
        <p className='text-gray-600 text-sm !leading-normal text-center md:text-start'> 
